...
# pancakeswap factory, router address and abi
...
def handle_event(event):
    ...
    token0 = Web3.toJSON(event['args']['token1'])
    token1 = Web3.toJSON(event['args']['token0'])
    ...
    if(token1 == tokenToBuy and token0 == wbnb):
        buy()
    elif(token0 == tokenToBuy and token1 == wbnb):
        buy()
    else:
        print("next pair")
